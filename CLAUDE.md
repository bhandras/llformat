...
3. **LeftFlowFormatter** (`formatter/left_flow_call_formatter.go`): Handles targeted function call argument reformatting
...
2. **Call Formatting**: Applies left-flow wrapping to specific function calls
...
- **Left-flow packing**: Pack arguments from left to right without exceeding column limit
