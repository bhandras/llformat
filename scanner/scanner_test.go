...
func TestScanString(t *testing.T) {
	...
	for _, tt := range tests {
		...
		if got != tt.want {
			t.Errorf("ScanString(%q, %d) = %d, want %d", tt.input,
...
func TestScanLineComment(t *testing.T) {
	...
	for _, tt := range tests {
		...
		if got != tt.want {
			t.Errorf("ScanLineComment(%q, %d) = %d, want %d",
				tt.input, tt.start, got, tt.want)
		}
	}
}
...
func TestScanBlockComment(t *testing.T) {
	...
	for _, tt := range tests {
		...
		if got != tt.want {
			t.Errorf("ScanBlockComment(%q, %d) = %d, want %d",
				tt.input, tt.start, got, tt.want)
		}
	}
}
...
func TestScanBalancedParen(t *testing.T) {
	...
	for _, tt := range tests {
		...
		if got != tt.want {
			t.Errorf("ScanBalancedParen(%q, %d) = %d, want %d",
				tt.input, tt.open, got, tt.want)
		}
	}
}
...
func TestSplitTopLevel(t *testing.T) {
	tests := []struct {
		...
		}, // brackets NOT respected by design
		{
			`a, "b,c", d`,
			[]string{
				"a",
	...
	for _, tt := range tests {
		...
		if !reflect.DeepEqual(got, tt.want) {
			t.Errorf("SplitTopLevel(%q) = %v, want %v", tt.input,
				got, tt.want)
		}
	}
}
...
func TestSplitTopLevelAny(t *testing.T) {
	...
	for _, tt := range tests {
		...
		if !reflect.DeepEqual(got, tt.want) {
			t.Errorf("SplitTopLevelAny(%q) = %v, want %v", tt.input,
				got, tt.want)
		}
	}
}
