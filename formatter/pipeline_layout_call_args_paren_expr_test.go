...
func TestPipelineDSLMultiLineLayoutArgsParenExprDoesNotPutCloseParenOnOwnLine(t *testing.T) {
	const in = `package p
...
`
	...
	// The inner logical chain should break, but `)` should not be on its own line
	// (Go semicolon insertion hazard).
