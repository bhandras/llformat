...
`)
	...
	require.Contains(t, out, "//go:generate go run ./tools/gen -flag=\"a b c\"\n")
	...
	require.Contains(t, out, "//nolint:errcheck // trailing prose should still be preserved verbatim\n")
	require.Contains(t, out, "// nolint:revive // space after // is still a directive-like comment\n")
	require.Contains(t, out, "//lint:ignore U1000 because it is used by generated code\n")
	require.Contains(t, out, "//staticcheck:ignore SA1019 keep for compatibility\n")
